  ...
  public async ensureSchemaUpToDate() {
    ...
    try {
      ...
      const statements = [
        ...
        { name: "modules.presentation_url", sql: sql`ALTER TABLE modules ADD COLUMN IF NOT EXISTS presentation_url VARCHAR(255)` },
        { name: "modules.presentation_data", sql: sql`ALTER TABLE modules ADD COLUMN IF NOT EXISTS presentation_data JSONB` },
        { name: "modules.mind_map_data", sql: sql`ALTER TABLE modules ADD COLUMN IF NOT EXISTS mind_map_data JSONB` },
