...
export class EnhancedModuleGenerator {
  ...
  private async loadPrompts(): Promise<{
    ...
    return {
      ...
      internetContentPrompt: internetContentPromptSetting?.value || 'Generálj frissített, részletes tartalmat az internet segítségével using actual information. KÖTELEZŐ VIZUÁLIS ELEMEK:\n1. Legalább egy Mermaid diagram (folyamatábra) a logikai lépésekhez.\n2. KÍSÉRLETI VIZUALIZÁCIÓ: Keresd meg a tananyag témája szerinti legfontosabb FIZIKAI vagy TECHNIKAI elemet (pl. egy szakmaspecifikus szerszám vázlata, egy szerkezeti csomópont, egy áramköri rajz, egy hullámforma vagy egy speciális munkafolyamat-mozzanat ábrázolása)! Ezt jelenítsd meg közvetlen <svg> kóddal a szövegben. A rajz legyen letisztult, szakmailag pontos technikai vázlat (fekete-fehér vagy mérnöki kék), ami vizuálisan magyarázza el a lényeget. Modulcím: {title}, Eredeti tartalom: {content}',
      conciseContentPrompt: conciseContentPromptSetting?.value || 'Készíts tömör, lényegre törő tananyagot maximum 250-300 szóban:\n\nCím: {title}\nEredeti tartalom: {content}\nSzakma: {profession}\nTantárgy: {subject}\n\nKÖVETELMÉNYEK:\n- MAXIMUM 250-300 szó\n- Csak a legfontosabb információk\n- Markdown formázás\n- VIZUÁLIS: Illessz be egy Mermaid folyamatábrát ÉS ha a szakmai téma igényli, egy univerzális technikai SVG rajzot a legfontosabb fizikai elemről vagy munkafolyamat-lépésről!\n\nVálasz:'
    };
  }
