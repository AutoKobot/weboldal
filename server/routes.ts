<<<<<<< Updated upstream
// This file is deprecated. Please use server/routes/index.ts instead.
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post('/api/school-admin/assign-student', combinedAuth, checkSchoolAdmin, async (req: any, res) => {
    try {
      ...
      // Verify the student belongs to this school admin
      ...
      // Verify the teacher belongs to this school admin
